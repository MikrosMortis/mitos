var languageContent = {
    greek: {
      languageBtn: "EL",
      mainTitle: "Βεβαίωση ανεργίας για παροχή ιατροφαρμακευτικής περίθαλψης",
      pageTitle: "Βεβαίωση ανεργίας για παροχή ιατροφαρμακευτικής περίθαλψης",
      infoTitle: "Πληροφορίες για την χορήγηση βεβαίωσης ανεργίας για παροχή ιατροφαρμακευτικής περίθαλψης",
      subTitle1: "Αυτό το ερωτηματολόγιο μπορεί να σας βοηθήσει να βρείτε αν δικαιούστε την βεβαίωση ανεργίας.",
    ...
    english: {
      languageBtn: "EN",
      mainTitle: "Unemployment certificate for the provision of medical care",
      pageTitle: "Unemployment certificate for the provision of medical care",
      infoTitle: "Information on the issue of unemployment certificate for the provision of medical care",
      subTitle1: "This questionnaire can help you determine if you are eligible to receive the unemployment certificate.",
